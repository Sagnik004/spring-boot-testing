...
public class MoneyTest {
    ...
    void testEquality() {
        ...
        assertNotEquals(Money.dollar(6), Money.dollar(12)); // Different amount, same currency
        assertNotEquals(Money.franc(6), Money.franc(12));   // Different amount, same currency
        assertNotEquals(Money.dollar(5), Money.franc(5));   // Same amount, different currency
    }
